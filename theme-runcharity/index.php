...
<head>
	...
	<meta name="author" content="">
        <title>'eS|Essential Smileys</title>
...
<div class="container">
	<div class="navbar-header">
		...
		<!-- Your Logo -->
                <a href="#hero" class="navbar-brand">ESSENTIAL <span class="lighter">SMILEYS</span></a>
	</div>
	<!-- Start Navigation -->
	...
	<ul class="nav navbar-nav">
		...
		<a href="#contactarea">Contact</a>
                ...
                <li>
                <a href="#contactarea">Servers</a>
                </li>
                <li>
                <a href="#contactarea">Chat</a>
                </li>
	</ul>
	</nav>
</div>
...
<div class="container">
	<div class="row">
		<div class="col-md-5">
			<div class="herotext">
                                <h1 class="wow bounceInDown" data-wow-duration="1s" data-wow-delay="0.1s">Essential <span class="lighter">Smileys</span></h1>
				<p class="lead wow zoomIn" data-wow-duration="2s" data-wow-delay="0.5s">
                                        A Cube 2: Sauerbraten team, family, and loving community.
				</p>
				<p>
                                        <a href="#gallery" class="btn btn-default btn-lg wow fadeInLeft" role="button"> View members</a> &nbsp; <a href="#" class="btn btn-default btn-lg wow fadeInRight" role="button">Download mappack</a>
				</p>
			</div>
		</div>
		<div class="col-md-7">
...
<section id="about" class="parallax section" style="background-image: url(file:///Users/ihartford/escube-website/theme-runcharity/backgrounds/screenshot_126370.png);">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6">
				<div class="service-box wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
                                        <img src="file:///Users/ihartford/escube-website/theme-runcharity/backgrounds/screenshot_126370.png)" alt="">
...
<!-- Random
	================================================== -->
<section class="parallax section" style="background-image: url(file:///Users/ihartford/escube-website/theme-runcharity/backgrounds/screenshot_126370.png);">
	<div class="wrapsection">
...
<!-- Gallery
	================================================== -->
<section id="gallery" class="parallax section" style="background-image: url(file:///Users/ihartford/escube-website/theme-runcharity/backgrounds/screenshot_126370.png);">
<div class="wrapsection">
		...
		<div class="row">
			<div class="col-md-12 sol-sm-12">
				<div class="maintitle">
					...
					<p class="lead wow flipInX">
                                                Have a look at our members list, so you can get to know us all!
					</p>
				</div>
			</div>
			...
			<div class="col-md-4">
				<a href="https://ununsplash.imgix.net/photo-1429277158984-614d155e0017?fit=crop&amp;fm=jpg&amp;h=700&amp;q=75&amp;w=1050" title="This is the description">
					...
					<div class="description">
                                                <span class="caption"><b>Latte</b></span>
			...
			<div class="col-md-4">
				...
				<img src="https://unsplash.imgix.net/uploads/14115408840644deb16b0/2dc933e3?fit=crop&amp;fm=jpg&amp;h=700&amp;q=75&amp;w=1050" alt="" class="image-responsive">
					<div class="description">
                                                <span class="caption"><b>Plasma</b></span>
			...
			<div class="col-md-4">
				...
				<img src="https://ununsplash.imgix.net/photo-1429277096327-11ee3b761c93?fit=crop&amp;fm=jpg&amp;h=700&amp;q=75&amp;w=1050" alt="" class="image-responsive">
					<div class="description">
                                                <span class="caption"><b>Marta</b></span>
			...
			<div class="col-md-4">
				...
				<img src="https://unsplash.imgix.net/uploads/141327328038701afeede/eda0fb7c?fit=crop&amp;fm=jpg&amp;h=700&amp;q=75&amp;w=1050" alt="" class="image-responsive">
					<div class="description">
                                                <span class="caption"><b>Chocolayte</b></span>
			...
			<div class="col-md-4">
				...
				<img src="https://ununsplash.imgix.net/photo-1418225043143-90858d2301b4?fit=crop&amp;fm=jpg&amp;h=700&amp;q=75&amp;w=1050" alt="" class="image-responsive">
					<div class="description">
                                                <span class="caption"><b>Chezerish</b></span>
			...
			<div class="col-md-4">
				...
				<img src="https://unsplash.imgix.net/photo-1428908799722-0a74e26ce7f6?fit=crop&amp;fm=jpg&amp;h=700&amp;q=75&amp;w=1050" alt="" class="image-responsive">
					<div class="description">
                                                <span class="caption"><b>Vienna</b></span>
...
<section id="slider" class="parallax section" style="background-image: url(file:///Users/ihartford/escube-website/theme-runcharity/backgrounds/screenshot_126370.png);">
							...
							<blockquote>
								<p class="lead">
									You have not lived today until you have done something for someone who can never repay you.
                                                                ...
                                                                <small>John Bunyan, Plasma</small>
							</blockquote>
						</div>
						<div class="item">
							<blockquote>
...
<!-- Random
	================================================== -->
<section class="whitecolor parallax section" style="background-image: url(file:///Users/ihartford/escube-website/theme-runcharity/backgrounds/screenshot_126370.png);">
<div class="wrapsection">
	<div class="container">
	<div class="row">
		<div class="col-md-12 sol-sm-12">
...
<!-- Contact
	================================================== -->
<section id="contactarea" class="parallax section" style="background-image: url(file:///Users/ihartford/escube-website/theme-runcharity/backgrounds/screenshot_126370.png);">
<div class="wrapsection">
...
$(function(){
	...
	if(index == 0 || index == 1){
		index = Math.floor(Math.random() * ((array.length - 2) - 2 + 1)) + 2;
	}

	$('#parallax').css('background', 'url(backgrounds/' + array[index] + ')');
	// $('#parallax').css('background', 'url(backgrounds/' + array[index] + ') center no-repeat');
